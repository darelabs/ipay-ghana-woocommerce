...
You can download the latest stable version of iPay Ghana WooCommerce WordPress plugin in your prefered format [zip format](https://github.com/darelabs/ipay-ghana-woocommerce/archive/1.0.0.zip) or [tar.gz format](https://github.com/darelabs/ipay-ghana-woocommerce/archive/1.0.0.tar.gz).
